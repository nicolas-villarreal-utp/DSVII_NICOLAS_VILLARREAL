...
$misAmigos = ['Luis','Omar','Jorge']; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Anthony", "Joselyn"); // Reemplaza las comillas vacías con los nombres de tus amigos
