...
$miArray = ['Futbol','Beisbol','Softbol']; // Reemplaza esto con tu propio array
$miString = "Buenos días Miami!"; // Reemplaza esto con tu propio string
$miNumero = 560; // Reemplaza esto con tu propio número
